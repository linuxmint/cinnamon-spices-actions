...
4. Overwrite Protection: The script now checks if a filename exists and automatically renames the output (e.g., file_1.png) to prevent accidental data loss.
5. Error Reporting: Added a detailed error log window that displays specific failure messages if a conversion is unsuccessful.
